...
stage('snyk-jira') {
		steps {
			script{
				...
				{
					bat 'C:\\Users\\Administrator\\Downloads\\snyk-jira-sync-win.exe --orgID=ea0871ca-05d5-4005-b34a-59f732ba9bb3 --token=snykSecrectS --jiraProjectKey=SNYK --configFile=true --jiraTicketType=Task --projectID=d5e50a37-e09a-4613-82d0-deaad1dffd03'
					bat 'exit 0'
				}
			}
		}
