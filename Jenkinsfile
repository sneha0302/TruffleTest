...
stage('defect-dojo')
{
	...
	steps
	{
		script
		{
			...
			{
				unstash report_name
				bat 'python dojo_ci_cd.py --product=5 --file '+report_name+' --scanner="Snyk Scan" --high=0 --host=https://demo.defectdojo.org --api_token=548afd6fab3bea9794a41b31da0e9404f733e222 --user=admin --engagement=18 --active TRUE'
			}
		}
	}
}
